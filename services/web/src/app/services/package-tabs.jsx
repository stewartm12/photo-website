...
export default function PackageTabs({ galleries }) {
  ...
  return (
    ...
    <Tabs defaultValue='1' className="w-full">
      ...
      {galleries.map((gallery) => (
        <TabsContent key={gallery.id} value={gallery.id} className="mt-0">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-1">
              <div className="sticky top-4">
                ...
                <h3 className="text-2xl font-semibold text-stone-800 mb-2">{gallery.name}</h3>
                ...
                {gallery.addOns && (
                  <div className="mt-6">
                    ...
                    <ul className="space-y-2">
                      {gallery.addOns.map((addon, index) => (
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {gallery.packages.sort((a, b) => a.price - b.price).map((pkg, index) => (
                  <Card
                    key={index}
