...
Rails.application.configure do
  ...
  # Set localhost to be used by rails application routes (overriding since the default host is api within docker).
  ...
  # Enable bullet gem for detecting N+1 queries and unused eager loading.
